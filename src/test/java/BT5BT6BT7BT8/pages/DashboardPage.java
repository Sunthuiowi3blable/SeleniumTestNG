...
public class DashboardPage extends CommonPage {
    ...
    public void checkTotalCustomer(){
        ...
        Assert.assertEquals(driver.findElement(totalCustomer).getText(), "188", "FAIL!! Cutomer total not match!");
    }
    ...
    public void checkTotalOrder(){
        ...
        Assert.assertEquals(driver.findElement(totalOrder).getText(), "740", "FAIL!! Order total not match!");
    }
    ...
    public void checkTotalProducCategory(){
        ...
        Assert.assertEquals(driver.findElement(totalProductCategory).getText(), "657", "FAIL!! Product Category total not match!");
    }
    ...
    public void checkTotalProductBrand(){
        ...
        Assert.assertEquals(driver.findElement(totalProductBrand).getText(), "84", "FAIL!! Product Brand total not match!");
    }
